...
export const Sidebar: React.FC<SidebarProps> = ({ 
    ...
    return (
        <>
            ...
            <div
                {...swipeHandlers} 
                className={`fixed top-0 right-0 h-full w-4/5 max-w-sm z-40 px-6 py-4 transition-transform duration-300 transform flex flex-col ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
            ...
            >
                ...
                <div className="flex-shrink-0 mt-auto pt-4 border-t border-gray-200 dark:border-gray-700">
                    <a 
                        href="https://github.com/adhi2006-ind" 
                        target="_blank" 
